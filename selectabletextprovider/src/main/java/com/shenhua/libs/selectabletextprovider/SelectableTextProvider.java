 ...
 */
public class SelectableTextProvider {

    private static final String TAG = "SelectableTextProvider";
    ...
    public SelectableTextProvider(Builder builder) {
    ...
    public void hide() {
        SelectableTextProvider.this.resetSelectionInfo();
        SelectableTextProvider.this.hideSelectView();
    }
    ...
    private class OperateWindow {
        ...
        public OperateWindow(final Context context) {
            View contentView = LayoutInflater.from(context).inflate(R.layout.selectable_text_provider_windows, null);
            ...
            contentView.findViewById(R.id.tv_select_share).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    String texts = mSelectionInfo.mSelectionContent;
                    hide();
    ...
    public static class Builder {
        ...
        public SelectableTextProvider build() {
            return new SelectableTextProvider(this);
        }
    }
